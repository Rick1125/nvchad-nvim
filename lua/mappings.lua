...
-- dap
map("n", "<leader>db", "<cmd>lua require'dap'.toggle_breakpoint()<CR>", { desc = "Toggle breakpoint", nowait = true })
map("n", "<leader>dc", "<cmd>lua require'dap'.continue()<CR>", { desc = "Continue", nowait = true })
map("n", "<leader>di", "<cmd>lua require'dap'.step_into()<CR>", { desc = "Step into", nowait = true })
map("n", "<leader>do", "<cmd>lua require'dap'.step_over()<CR>", { desc = "Step over", nowait = true })
map("n", "<leader>dO", "<cmd>lua require'dap'.step_out()<CR>", { desc = "Step out", nowait = true })
map("n", "<leader>dS", "<cmd>lua require'dap'.run_to_cursor()<CR>", { desc = "Run to cursor", nowait = true })
map("n", "<leader>dt", "<cmd>lua require'dap'.terminate()<CR>", { desc = "Terminate", nowait = true })
